...
// the types.
export { evaluateFlag, evaluateVariant, FlagwardClient, toFlagMap } from "@flagward/core";
export type {
  Condition,
  Flag,
  FlagData,
...
export { variantStore } from "./variantStore.js";
export type { VariantState, UseVariantResult } from "./variantStore.js";
